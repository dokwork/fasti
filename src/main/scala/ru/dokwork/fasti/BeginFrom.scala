...
object BeginFrom {
  ...
  implicit def ev4single[H, T <: HList]: BeginFrom[H :: T, H :: HNil] = new BeginFrom[H :: T, H :: HNil] {}

  implicit def ev4list[H, TS <: HList, TP <: HList](implicit t: BeginFrom[TS, TP]): BeginFrom[H :: TS, H :: TP] =
